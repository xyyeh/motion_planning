...
cfg.time_interval = 0.1  # time interval for computing velocity, does not need to be the same as sampling time
...
cfg.link_smooth_weight = np.ones(7) # link smooth weight depending on size
...
cfg.obj_point_num = 800  # object points for KDTree in iterative surface fitting
